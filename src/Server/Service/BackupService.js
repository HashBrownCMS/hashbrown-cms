...
class BackupService {
        ...
        let handler = Multer({
            storage: Multer.diskStorage({
                destination: (req, file, resolve) => {
                    ...
                    HashBrown.Service.FileService.makeDirectory(path)
                    .then(() => {
                        resolve(null, path);
                    });
                },
    ...
    static restoreBackup(projectName, timestamp) {
        return HashBrown.Service.DatabaseService.restore(projectName, timestamp);
    }
    ...
    static createBackup(projectName) {
        ...
        return HashBrown.Service.DatabaseService.dump(projectName);
    }
