 ...
 */
class UrlEditor extends HashBrown.View.Editor.FieldEditor.FieldEditor {
    constructor(params) {
        super(params);
    ...
    async generateUrl(contentId) {
        let ancestors = await HashBrown.Service.ContentService.getContentAncestorsById(contentId, true);
        ...
        for(let ancestor of ancestors) {
            ...
            url += HashBrown.Service.ContentService.getSlug(title) + '/';
        }
