...
class LocaleService {
    ...
    static getLocaleOptions(includeNames = false) {
        let locales = {
            ...
            'Burmese': 'my',
            'Cantonese (Traditional, Hong Kong SAR China)': 'yue_Hant_HK',
            'Catalan (Spain)': 'ca_ES',
            'Catalan': 'ca',
            ...
            'Chinese (Simplified Han, Hong Kong SAR China)': 'zh_Hans_HK',
            'Chinese (Simplified Han, Macau SAR China)': 'zh_Hans_MO',
            'Chinese (Simplified Han, Singapore)': 'zh_Hans_SG',
            'Chinese (Traditional Han)': 'zh_Hant',
            'Chinese (Traditional Han, Hong Kong SAR China)': 'zh_Hant_HK',
            'Chinese (Traditional Han, Macau SAR China)': 'zh_Hant_MO',
