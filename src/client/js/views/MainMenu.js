        ...
        switch(level1) {
            ...
            case 'content':
                UI.messageModal('Content', [ 
                    _.p('This sections contains all of your authored work. The content is a hierarchical tree of nodes that can contain text and media, in simple or complex structures.')
                ]);
                break;
