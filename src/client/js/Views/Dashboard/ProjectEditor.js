...
class ProjectEditor extends View {
    ...
    onClickInfo() {
        ...
        let infoEditor = new HashBrown.Views.Dashboard.InfoEditor({ projectId: this.model.id });
    ...
    onClickSync() {
        ...
        let syncEditor = new HashBrown.Views.Dashboard.SyncEditor({ projectId: this.model.id });
    ...
    onClickLanguages() {
        ...
        let languageEditor = new HashBrown.Views.Dashboard.LanguageEditor({ projectId: this.model.id });
    ...
    onClickBackups() {
        ...
        new HashBrown.Views.Dashboard.BackupEditor({ model: this.model });
    }
    ...
    onClickMigrate() {
        ...
        new HashBrown.Views.Dashboard.MigrationEditor({ model: this.model });
    }
