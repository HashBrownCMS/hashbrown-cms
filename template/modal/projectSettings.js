...
_.div({class: 'modal'},
    _.div({class: 'modal__dialog'},
        ...
        _.div({class: 'modal__body'},
            ...
            _.div({class: 'widget-group'},
                _.label({class: 'widget widget--label'}, 'Languages'),
            ...
            _.h4('Sync'),
            _.div({class: 'widget-group'},
                _.label({class: 'widget widget--label'}, 'Enabled'),
            ...
            _.div({class: 'widget-group'},
                _.label({class: 'widget widget--label'}, 'API URL'),
                new HashBrown.View.Widget.Input({
                    name: 'url',
                    type: 'text',
            ...
            _.div({class: 'widget-group'},
                _.label({class: 'widget widget--label'}, 'Project id'),
                new HashBrown.View.Widget.Input({
                    name: 'name',
            ...
            _.div({class: 'widget-group modal--project-settings__sync-token__input'},
                _.label({class: 'widget widget--label'}, 'Token'),
                new HashBrown.View.Widget.Input({
