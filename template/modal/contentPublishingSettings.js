...
_.div({class: 'modal in'},
    _.div({class: 'modal__dialog'},
        _.div({class: 'modal__header'},
            _.h4({class: 'modal__title'}, `Publishing settings for ${state.title}`),
        ...
        _.div({class: 'modal__body'},
            ...
            _.if(state.name === undefined,
                _.div({class: 'widget-group'},      
                    _.label({class: 'widget widget--label small'}, 'Apply to children'),
                    _.checkbox({
                ...
                _.div({class: 'widget-group'},      
                    _.label({class: 'widget widget--label small'}, 'Connection'),
                    _.popup({
