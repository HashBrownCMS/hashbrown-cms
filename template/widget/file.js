...
_.form({class: `widget widget--file widget-group ${model.class || ''}`, title: model.tooltip, onsubmit: _.onSubmit},
    ...
    typeof model.onsubmit === 'function' ? [
        _.button({name: 'submit', class: 'widget widget--button small fa fa-upload', type: 'submit', title: 'Upload'})
    ] : null,
    model.clearable ? [
        _.button({name: 'clear', class: 'widget widget--button small fa fa-remove', title: 'Clear', onclick: _.onClear})
    ] : null
)
