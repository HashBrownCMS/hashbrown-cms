...
_.ul({class: 'widget widget--list'},
    _.each(model.value, (key, value) =>
        _.li({class: 'widget--list__item widget-group'},
            _.if(model.keys,
                _.input({type: 'text', disabled: model.disabled, class: 'widget widget--input text', value: key, onchange: (e) => _.onChangeItemKey(key, e.target.value)}),
            ),
            _.input({type: 'text', disabled: model.disabled, class: 'widget widget--input text', value: value, onchange: (e) => _.onChangeItemValue(key, e.target.value)}),
            _.if(!model.disabled,
