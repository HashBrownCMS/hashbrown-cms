...
if(!noGlobal){window.jQuery=window.$=jQuery;}return jQuery;});},{}],16:[function(require,module,exports){var isarray=require('isarray'); /**
 * Expose `pathToRegexp`.
...
}else {getModel();}}}]);return View;}();window.View=View;},{}],21:[function(require,module,exports){require('./Router');require('./Templating');require('./View');require('./ContextMenu');},{"./ContextMenu":17,"./Router":18,"./Templating":19,"./View":20}],22:[function(require,module,exports){'use strict'; // Libraries
require('putaitu.js');window.$=window.jQuery=require('jquery');require('bootstrap'); // Views
var JSONEditor=require('./views/JSONEditor');Router.route('/jsoneditor/page/:id',function(){var jsonEditor=new JSONEditor({modelUrl:'/api/content/page/'+this.id});$('body').html(jsonEditor.$element);});Router.init();},{"./views/JSONEditor":23,"bootstrap":1,"jquery":15,"putaitu.js":21}],23:[function(require,module,exports){'use strict';var JSONEditor=function(_View2){_inherits(JSONEditor,_View2);function JSONEditor(params){_classCallCheck(this,JSONEditor);var _this2=_possibleConstructorReturn(this,Object.getPrototypeOf(JSONEditor).call(this,params));_this2.$element=_.div({class:'json-editor flex-vertical'});_this2.fetch();return _this2;}_createClass(JSONEditor,[{key:"render",value:function render(){this.$element.html([_.textarea({class:'flex-expand'},JSON.stringify(this.model)),_.div({class:'btn-group flex-horizontal'},[_.button({class:'btn btn-primary flex-expand'},'Reload'),_.button({class:'btn btn-success flex-expand'},'Save')])]);}}]);return JSONEditor;}(View);module.exports=JSONEditor;},{}]},{},[22]);