...
var JSONEditor=require('./views/JSONEditor');Router.route('/jsoneditor/page/:id',function(){alert(this.id);$('body').html(new JSONEditor({modelUrl:'/api/content/page/'+this.id}).$element);});Router.init();},{"./views/JSONEditor":23,"bootstrap":1,"jquery":15,"putaitu.js":21}],23:[function(require,module,exports){'use strict';var JSONEditor=function(_View2){_inherits(JSONEditor,_View2);function JSONEditor(params){_classCallCheck(this,JSONEditor);var _this2=_possibleConstructorReturn(this,Object.getPrototypeOf(JSONEditor).call(this,params));_this2.$element=_.div({class:'json-editor'});_this2.fetch();return _this2;}_createClass(JSONEditor,[{key:"render",value:function render(){this.$element.html(_.textarea(JSON.stringify(this.model)));}}]);return JSONEditor;}(View);},{}]},{},[22]);