                ...
                _.div({class: 'row'}, [
                    ...
                    _.div({class: 'col-md-6'},
                        _.div({class: 'btn-group'}, [
                            _.a({class: 'btn btn-default', href: '/repos/' + params.repo + '/stage/cms/'},
                                'Go to CMS'
                            ),
                            _.a({class: 'btn btn-default', href: '/repos/' + params.repo + '/stage/'},
                                'Go to website'
                           )
                        ])
                    )
        ...
        _.div({class: 'panel panel-primary'}, [
            ...
            _.div({class: 'panel-body'},
                _.div({class: 'row'}, [
                    ...
                    _.div({class: 'col-md-6'},
                        _.div({class: 'btn-group'}, [
                            _.a({class: 'btn btn-default', href: '/repos/' + params.repo + '/live/cms/'},
                                'Go to CMS'
                            ),
                            _.a({class: 'btn btn-default', href: '/repos/' + params.repo + '/live/'},
                                'Go to website'
                            )
                        ])
                    )
...
},{"../client":1,"./navbar":4}],4:[function(require,module,exports){
$('.navbar-content').html(
