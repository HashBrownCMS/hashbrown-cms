...
(function e(t, n, r) {
    function s(o, u) {
        ...
        var Deployment = (function (_View2) {
            _inherits(Deployment, _View2);

            function Deployment(args) {
                _classCallCheck(this, Deployment);

                var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(Deployment).call(this, args));

                _this2.modelFunction = api.branches.get;
