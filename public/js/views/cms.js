    ...
    function s(o, u) {
        ...
        var Editor = function (_View3) {
            ...
            function Editor(args) {
                ...
                _this3.$element = _.div({ class: 'panel panel-default editor' }, [_.div({ class: 'panel-body' }, _.div({ class: 'row' }, [_.div({ class: 'col-md-3 editor-nav' }, _.div({}, [_.div({ class: 'btn-group-vertical field-anchors' }), _.div({ class: 'btn-group content-actions' }, [_.button({ class: 'btn btn-primary btn-publish' }, ['Save ', _.span({ class: 'glyphicon glyphicon-floppy-disk' })]).click(_this3.events.clickSave), _.button({ class: 'btn btn-success btn-publish' }, ['Publish ', _.span({ class: 'glyphicon glyphicon-upload' })]).click(_this3.events.clickPublish)])])), _.div({ class: 'col-md-9 editor-content' }, [_.h1('Welcome to the Putaitu CMS editor!'), _.p('Pick a content node from the navigation menu above to begin')])]))]);
                return _this3;
            }
            ...
            _createClass(Editor, [{
                ...
                value: function clear() {
                    this.$element.find('editor-content').html(_.div({ class: 'spinner-container' }, _.div({ class: 'spinner' })));
                }
            }, {
                key: "openAsync",
                ...
                key: "renderModelData",
                value: function renderModelData(modelData, $el, anchorNav) {
                    $el.empty();
                    ...
                    for (var anchorLabel in modelData) {
                        ...
                        if (anchorNav) {
                            ...
                            var $btn = this.$element.find('.field-anchors').append(_.button({ class: 'btn btn-default', 'aria-scrollto': 'anchor-' + anchorLabel }, anchorLabel).click(onClickAnchor));
                        }
        ...
        var Tree = function (_View4) {
            ...
            function Tree(args) {
                ...
                // Prerender container
                _this4.$element = _.div({ class: 'tree' }, _.div({ class: 'container' }, _.div({ class: 'panel panel-default' }, [_.div({ class: 'panel-heading' }), _.div({ class: 'panel-body' })])));
            ...
            _createClass(Tree, [{
                ...
                key: "picker",
                value: function picker(path) {
                    this.highlight(path, true);
                }
            }, {
                key: "highlight",
                value: function highlight(path, expandPane) {
        ...
        var BlockPicker = function (_FieldEditor) {
            ...
            function BlockPicker(args) {
                _classCallCheck(this, BlockPicker);

                var _this5 = _possibleConstructorReturn(this, Object.getPrototypeOf(BlockPicker).call(this, args));

                _this5.fetch();
                return _this5;
            }

            _createClass(BlockPicker, [{
                key: "renderField",
                value: function renderField(value) {
                    ...
                    return _.div({ class: 'block-picker' }, _.button({ class: 'btn btn-default' }, value || '...')).click(onClick);
                }
            }]);
